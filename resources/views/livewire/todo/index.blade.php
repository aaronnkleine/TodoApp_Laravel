<div>
    ...
    <div class="py-12">
        ...
        <div class=" mx-auto sm:px-6 lg:px-8">
            <section class="max-w-3/4 px-4 mx-auto">
                            ...
                            <div class="overflow-hidden md:rounded-md">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 cursor-pointer"></th>
                                        <th scope="col"
                                            ...
                                            <td>
                                                <div>
                                                    <label wire:click.debounce="changeState({{ $todo->id }})"
                                                        ...
                                                        <div class="relative">
                                                            <input
                                                                {{ $todo->state ? 'checked': '' }} wire:key="todo-switch-{{ $todo->id }}"
                                                                type="checkbox"
                                                                class="peer sr-only"
                                                            />
                                                            <div
