                    ...
                    <div class="overflow-hidden md:rounded-md">
                        ...
                        <div class="text-black/50">
                            ...
                            <div
                                ...
                                <div
                                    class="min-w-screen py-6 flex flex-col justify-center sm:py-12 w-full items-center">
                                    <div class="py-3 w-3/4 sm:w-2/3 lg:w-1/2">
                                        ...
                                        <div class="bg-white flex flex-col rounded-xl shadow-lg w-full">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="sm:col-span-3">
                                                        ...
                                                        >
                                                            <option value="low" {{ $this->priority === 'low' ? 'selected' : '' }}>{{ __('Low') }}</option>
                                                            <option value="medium" {{ $this->priority === 'medium' ? 'selected' : '' }}>{{ __('Medium') }}</option>
                                                            <option value="high" {{ $this->priority === 'high' ? 'selected' : '' }}>{{ __('High') }}</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <textarea type="text" name="description" id="description"
                                                      autocomplete="off" wire:model.live="description"
                                                    ...
                                                    <div class="col-span-full">
                                                        ...
                                                        <div class="mt-2">
                                                            <input type="text" name="notes" id="notes"
                                                                   autocomplete="off" wire:model.live="notes"
                                                                   class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="sm:col-span-3">
                                                        ...
                                                        <div class="mt-2">
                                                            <input type="text" name="location" id="location"
                                                                   autocomplete="off" wire:model.live="location"
                                                                   class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="relative sm:col-span-3">
                                                        ...
                                                        <input id="deadline" name="deadline" datepicker
                                                               datepicker-buttons wire:model.live="deadline"
