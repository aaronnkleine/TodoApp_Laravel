                            ...
                            <div
                                ...
                                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <select id="priority" name="priority" class="mt-2 px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                                                required>
                                            <option value="low" {{ $todo->priority === 'low' ? 'selected' : '' }}>{{ __('Low') }}</option>
                                            <option value="medium" {{ $todo->priority === 'medium' ? 'selected' : '' }}>{{ __('Medium') }}</option>
                                            <option value="high" {{ $todo->priority === 'high' ? 'selected' : '' }}>{{ __('High') }}</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea type="text" name="description" id="description"
                                                      class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{$todo->description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative sm:col-span-3">
                                        ...
                                        <input id="deadline" name="deadline" datepicker datepicker-buttons datepicker-autoselect-today datepicker-autohide
                                               autocomplete="off"
                                               type="text"
